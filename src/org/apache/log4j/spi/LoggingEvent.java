...
public class LoggingEvent implements java.io.Serializable {
  ...
  /** Fully qualified name of the calling category class. <br>
   *  日志记录接口（默认为Logger）的类全名，该信息主要用于计算日志记录点的源文件、调用方法以及行号等位置信息。
   * */
   ...
   * 
   * <p>目前来看主要是通过Logger实例取得LogRepository实例，并通过LogRepository取得注册的ObjectRender实例，如果有的话.
   * 
  ...
  /** The application supplied message rendered through the log4j
      objet rendering mechanism.
       <p>经过ObjectRender处理后的日志信息，提供给Layout使用。
      */
  ...
  /** This
      ...
      <p>异常信息，如果存在的话，提供给Layout使用。
  */
  private ThrowableInformation throwableInfo;

  /** The number of milliseconds elapsed from 1/1/1970 until logging event
      was created. 
      <p>创建LoggingEvent实例的时间，提供给Layout使用。
      */
